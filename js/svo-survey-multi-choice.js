var jsPsychSVOMultiChoice = (function (jspsych) {
  'use strict';

  const info = {
      name: "svo-multi-choice",
      parameters: {
      ...
      trial(display_element, trial) {
          ...
          html +=
              ".jspsych-survey-multi-choice-question { margin-top: 2em; margin-bottom: 2em; text-align: left; }" +
                  ...
                  ".jspsych-survey-multi-choice-option { line-height: 1.4; }" +
          ...
          for (var i = 0; i < trial.questions.length; i++) {
              ...
              html +=
                  '<div id="jspsych-survey-multi-choice-' +
                      ...
                      '">';
              // add question text
              html += '<div style = "display: inline-block; margin-right: 5em"> <p class="jspsych-survey-multi-choice-text survey-multi-choice">' + question.prompt;
              ...
              for (var j = 0; j < question.options.length; j++) {
                  ...
                  html += '<label class="jspsych-survey-multi-choice-text" style="white-space: break-spaces; margin: 20px 20px;" for="' + input_id + '">';
                  html +=
  ...
  SVOMultiChoicePlugin.info = info;

  return SVOMultiChoicePlugin;
